...
const ContactUsForm = () => {
  const inputClass =
    "border border-[#888888] rounded-none p-3.5 w-[200px] md:w-[340px] lg:w-[400px] md:w-[200px] mb-6 bg-bgInput";
  ...
  return (
    <div className="bg-[url('/form-bg-img.jpg')] bg-cover bg-center py-[120px] w-full flex flex-col justify-center items-center">
     <div className="bg-white py-[30px] px-[20px] md:px-[180px] border-t-2 border-customPrimary rounded-lg shadow-md">
